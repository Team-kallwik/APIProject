using Dapper_Token_Api.Repository.Implementation;
...
builder.Services.AddSwaggerGen(c =>
{
    ...
    {
        Title = "Dapper Token API",
        Version = "v1",
        Description = "A comprehensive API with JWT authentication using Dapper and Repository pattern"
    });
